...
public class MurmurHashs {
	...
	public static void main(String[] args){
		String str = "";
	    System.out.println(MurmurHashs.hash64((new String("http://www.ny21.cn/info_show.asp?type=石油石化&smalltype=石油石化&ID=16494")).getBytes()));
        System.out.println(MurmurHashs.hash64((new String("http://www.ny21.cn/info_show.asp?type=石油石化&smalltype=石油石化&ID=16491")).getBytes()));
	}
}
